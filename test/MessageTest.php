...
class MessageTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->message->addFrom('api-tools-devteam@zend.com');
    ...
    {
        $this->message->addTo('api-tools-devteam@zend.com');
    ...
    {
        $this->message->addCc('api-tools-devteam@zend.com');
    ...
    {
        $this->message->addBcc('api-tools-devteam@zend.com');
    ...
    {
        $this->message->addReplyTo('api-tools-devteam@zend.com');
    ...
    {
        $this->message->setSender('api-tools-devteam@zend.com');
    ...
    {
        $this->message->setSender('api-tools-devteam@zend.com', 'Laminas DevTeam');
        $sender = $this->message->getSender();
        $this->assertInstanceOf('Laminas\Mail\Address', $sender);
    ...
    {
        $sender = new Address('api-tools-devteam@zend.com');
    ...
    {
        $this->message->addFrom('api-tools-devteam@zend.com', 'Laminas DevTeam');
    ...
    public function testCanAddManyFromAddressesUsingArray()
    {
        ...
        $this->assertTrue($from->has('api-tools-devteam@zend.com'));
        $this->assertTrue($from->has('api-tools-contributors@lists.zend.com'));
    ...
    public function testCanAddManyFromAddressesUsingAddressListObject()
    {
        ...
        $list->add('api-tools-devteam@zend.com');
    ...
    {
        $this->message->addCc('api-tools-devteam@zend.com', 'Laminas DevTeam');
    ...
    public function testCanAddManyCcAddressesUsingArray()
    {
        ...
        $this->assertTrue($cc->has('api-tools-devteam@zend.com'));
        $this->assertTrue($cc->has('api-tools-contributors@lists.zend.com'));
    ...
    {
        $this->message->addBcc('api-tools-devteam@zend.com', 'Laminas DevTeam');
    ...
    public function testCanAddManyBccAddressesUsingArray()
    {
        ...
        $this->assertTrue($bcc->has('api-tools-devteam@zend.com'));
        $this->assertTrue($bcc->has('api-tools-contributors@lists.zend.com'));
    ...
    {
        $this->message->addReplyTo('api-tools-devteam@zend.com', 'Laminas DevTeam');
    ...
    public function testCanAddManyReplyToAddressesUsingArray()
    {
        ...
        $this->assertTrue($replyTo->has('api-tools-devteam@zend.com'));
        $this->assertTrue($replyTo->has('api-tools-contributors@lists.zend.com'));
    ...
    {
        $this->message->addTo('api-tools-devteam@zend.com', 'Laminas DevTeam');
        $this->message->addFrom('matthew@zend.com', "Matthew Weier O'Phinney");
        $this->message->addCc('api-tools-contributors@lists.zend.com', 'Laminas Contributors List');
        $this->message->addBcc('api-tools-crteam@lists.zend.com', 'Laminas CR Team');
        $this->message->setSubject('This is a subject');
        $this->message->setEncoding('UTF-8');
        ...
        $this->assertContains('<api-tools-devteam@zend.com>', $test);
        ...
        $this->assertContains($expected, $test);
        $this->assertContains('<api-tools-contributors@lists.zend.com>', $test);

        $expected = '=?UTF-8?Q?Laminas=20CR=20Team?=';
        $this->assertContains($expected, $test);
        $this->assertContains('<api-tools-crteam@lists.zend.com>', $test);
