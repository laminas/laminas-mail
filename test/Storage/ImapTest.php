...
class ImapTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->params = array('host'     => TESTS_LAMINAS_MAIL_IMAP_HOST,
        ...
        if (defined('TESTS_LAMINAS_MAIL_SERVER_TESTDIR') && TESTS_LAMINAS_MAIL_SERVER_TESTDIR) {
            ...
            $this->cleanDir(TESTS_LAMINAS_MAIL_SERVER_TESTDIR);
            $this->copyDir(
                __DIR__ . '/../_files/test.' . TESTS_LAMINAS_MAIL_SERVER_FORMAT,
    ...
    {
        $this->params['port'] = TESTS_LAMINAS_MAIL_IMAP_INVALID_PORT;
        $this->setExpectedException('Laminas\Mail\Storage\Exception\InvalidArgumentException');
        new Storage\Imap($this->params);
    }
    ...
    {
        $this->params['port'] = TESTS_LAMINAS_MAIL_IMAP_WRONG_PORT;
        $this->setExpectedException('Laminas\Mail\Storage\Exception\InvalidArgumentException');
        new Storage\Imap($this->params);
    }
